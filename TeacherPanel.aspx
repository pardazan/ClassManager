<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TeacherPanel.aspx.cs" Inherits="ClassManager.TeacherPanel" %>
...
<body>
    <form id="form1" runat="server">
        <div class="pagetitle">
            ...
            <br />
            <asp:Button ID="btnRegister" runat="server" class="Button" Width="405px" Text="ثبت آزمون یا تکلیف جدید" OnClick="btnRegister_Click"/>
            <br />
            <br />
